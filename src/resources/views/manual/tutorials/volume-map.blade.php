...
<div class="row">
    ...
    <p class="text-center">
        <a href="{{asset('vendor/geo/assets/volume_map_1.png')}}"><img src="{{asset('vendor/geo/assets/volume_map_1.png')}}" width="90%"></a>
    </p>
    <p>
    ...
    <p class="text-center">
        <a href="{{asset('vendor/geo/assets/volume_map_2.png')}}"><img src="{{asset('vendor/geo/assets/volume_map_2.png')}}" width="90%"></a>
    </p>
    <h3>Geo filter</h3>
    <p>
