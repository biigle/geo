...
class VolumeImagesControllerTest extends ApiTestCase
{
  public function testIndex()
  {
    ...
    $this->doTestApiRoute('GET', "/api/v1/geojson/volume/{$volume->id}/images");

    $this->beUser();
    $response = $this->get("/api/v1/geojson/volume/{$volume->id}/images");
